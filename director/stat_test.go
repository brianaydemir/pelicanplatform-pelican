...
func TestQueryServersForObject(t *testing.T) {
	...
	require.NoError(t, param.Director_MaxStatResponse.Set(1))
	require.NoError(t, param.Director_StatTimeout.Set(time.Microsecond*200))
	...
	t.Run("matched-prefixes-with-max-2-returns-response", func(t *testing.T) {
		...
		require.NoError(t, param.Director_MaxStatResponse.Set(2))
		t.Cleanup(func() {
			require.NoError(t, param.Director_MaxStatResponse.Set(1))
		})
	...
	t.Run("matched-prefixes-with-max-3-returns-response", func(t *testing.T) {
		...
		require.NoError(t, param.Director_MaxStatResponse.Set(3))
		t.Cleanup(func() {
			require.NoError(t, param.Director_MaxStatResponse.Set(1))
		})
	...
	t.Run("matched-prefixes-with-min-3-returns-error", func(t *testing.T) {
		...
		require.NoError(t, param.Director_MinStatResponse.Set(3))
...
func TestGenerateAvailabilityMaps(t *testing.T) {
	...
	t.Run("skip-stat-path-maps-keyed-by-url", func(t *testing.T) {
		server_utils.ResetTestState()
		require.NoError(t, param.Director_CheckCachePresence.Set(false))
		require.NoError(t, param.Director_CheckOriginPresence.Set(false))
	...
	t.Run("stat-results-maps-keyed-by-url", func(t *testing.T) {
		server_utils.ResetTestState()
		require.NoError(t, param.Director_CheckCachePresence.Set(true))
		require.NoError(t, param.Director_CheckOriginPresence.Set(false))
		require.NoError(t, param.Director_StatTimeout.Set(2*time.Second))
		require.NoError(t, param.Director_MinStatResponse.Set(1))
		require.NoError(t, param.Director_MaxStatResponse.Set(1))
